...
unzip Geist.Mono.zip -d Geist.Mono_temp
...
mv Geist.Mono_temp/*.ttf ./vercel/output/functions/api/card.func/.next/server/app/api/card/fonts/

# Step 5: Cleanup
rm -rf Geist.Mono_temp && rm Geist.Mono.zip
